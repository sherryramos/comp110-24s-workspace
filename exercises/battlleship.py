...
elif user_guesslocation == 1 and user_boatlocation != 1:
    print(WHITE_BOX + BLUE_BOX * 3)
elif user_guesslocation == 2 and user_boatlocation == 2:
    print(BLUE_BOX + RED_BOX + BLUE_BOX * 2)
elif user_guesslocation == 2 and user_boatlocation != 2:
    print(BLUE_BOX + WHITE_BOX + BLUE_BOX * 2)
elif user_guesslocation == 3 and user_boatlocation == 3:
    print(BLUE_BOX * 2 + RED_BOX + BLUE_BOX)
elif user_guesslocation == 3 and user_boatlocation != 3:
    print(BLUE_BOX * 2 + WHITE_BOX + BLUE_BOX)
elif user_guesslocation == 4 and user_boatlocation == 4:
...
elif user_boatlocation != user_guesslocation:
